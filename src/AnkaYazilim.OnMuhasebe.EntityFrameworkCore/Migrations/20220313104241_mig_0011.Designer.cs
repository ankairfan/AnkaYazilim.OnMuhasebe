...
namespace AnkaYazilim.OnMuhasebe.Migrations
{
    ...
    [Migration("20220313104241_mig_0011")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.BankaSubeler.BankaSube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.Banks.Banka", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.Kasalar.Kasa", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.Makbuzlar.Makbuz", b =>
                {
                    ...
                    b.Property<decimal?>("BankaToplamTutar")
                        .IsRequired()
                        .HasColumnType("Money");
                    ...
                    b.Property<decimal?>("CekToplamTutar")
                        .IsRequired()
                        .HasColumnType("Money");
                    ...
                    b.Property<decimal?>("NakitToplamTutar")
                        .IsRequired()
                        .HasColumnType("Money");
                    ...
                    b.Property<decimal?>("PosToplamTutar")
                        .IsRequired()
                        .HasColumnType("Money");

                    b.Property<decimal?>("SenetToplamTutar")
                        .IsRequired()
                        .HasColumnType("Money");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.OdemeBelgeleri.OdemeBelgesi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.OzelKodlar.OzelKod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Parameters.Donemler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Parameters.FirmalarParametre.FirmaParametre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppFirmaParametreleri", (string)null);
                });

            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Sales.Cariler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Sales.Faturalar.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Sales.Faturalar.FaturaHareket", b =>
                {
                    ...
                    b.ToTable("AppFaturaHareketleri", (string)null);
                });

            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Stocks.Birimler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Stocks.Depolar.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Stocks.Stoklar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Subeler.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.BankaHesaplar.BankaHesap", b =>
                {
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Finance.BankaSubeler.BankaSube", "BankaSube")
                        .WithMany("BankaHesaplar")
                        .HasForeignKey("BankaSubeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.OzelKodlar.OzelKod", "OzelKod1")
                        .WithMany("OzelKod1BankaHesaplar")
                        .HasForeignKey("OzelKod1Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.OzelKodlar.OzelKod", "OzelKod2")
                        .WithMany("OzelKod2BankaHesaplar")
                        .HasForeignKey("OzelKod2Id")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Subeler.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.BankaSubeler.BankaSube", b =>
                {
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Finance.Banks.Banka", "Banka")
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.Makbuzlar.Makbuz", b =>
                {
                    ...
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Sales.Cariler.Cari", "Cari")
                        .WithMany("Makbuzlar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Parameters.Donemler.Donem", "Donem")
                        .WithMany("Makbuzlar")
                        .HasForeignKey("DonemId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Finance.Kasalar.Kasa", "Kasa")
                        .WithMany("Makbuzlar")
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Finance.Makbuzlar.MakbuzHareket", b =>
                {
                    ...
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Finance.Banks.Banka", "CekBanka")
                        .WithMany("MakbuzHareketleri")
                        .HasForeignKey("CekBankaId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Finance.BankaSubeler.BankaSube", "CekBankaSube")
                        .WithMany("MakbuzHareketleri")
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Hizmetler.Hizmet", b =>
                {
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Stocks.Birimler.Birim", "Birim")
                        .WithMany("Hizmetler")
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Parameters.FirmalarParametre.FirmaParametre", b =>
                {
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Stocks.Depolar.Depo", "Depo")
                        .WithMany("FirmaParametreleri")
                    ...
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("AnkaYazilim.OnMuhasebe.Entities.Parameters.FirmalarParametre.FirmaParametre", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Sales.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Stocks.Depolar.Depo", "Depo")
                        .WithMany("FaturaHareketleri")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Sales.Faturalar.Fatura", "Fatura")
                        .WithMany("FaturaHareketleri")
                        .HasForeignKey("FaturaId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Hizmetler.Hizmet", "Hizmet")
                        .WithMany("FaturaHareketleri")
                        .HasForeignKey("HizmetId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Masraflar.Masraf", "Masraf")
                        .WithMany("FaturaHareketleri")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AnkaYazilim.OnMuhasebe.Entities.Stocks.Stoklar.Stok", "Stok")
                        .WithMany("FaturaHareketleri")
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Hizmetler.Hizmet", b =>
                {
                    b.Navigation("FaturaHareketleri");
                });
            ...
            modelBuilder.Entity("AnkaYazilim.OnMuhasebe.Entities.Parameters.Donemler.Donem", b =>
                {
                    ...
                    b.Navigation("FirmaParametreleri");
