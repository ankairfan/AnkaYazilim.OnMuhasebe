...
public class FaturaHareketService : BaseHareketService<SelectFaturaHareketDto>, IScopedDependency
{
    ...
    public override void Hesapla(object value, string propertyName)
    {
        ...
        TempDataSource.BrutTutar = TempDataSource.Miktar * TempDataSource.Fiyat;
        ...
        TempDataSource.NetTutar = (TempDataSource.Miktar * TempDataSource.Fiyat) - TempDataSource.IndirimTutar;
